      ...
      <p className="text-sm text-ink-muted mb-8">Manage your subscription and view usage.</p>
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          <div className={`p-6 rounded-2xl border-2 flex flex-col ${plan === "free" ? "border-terracotta bg-white" : "border-border bg-white"}`}>
            ...
            <ul className="space-y-2 mb-5 flex-1">
              ...
              <li className="text-xs text-ink-muted"><span className="text-sage font-bold mr-2">&#10003;</span>SEO Analyzer (unlimited)</li>
          ...
          <div className={`p-6 rounded-2xl border-2 flex flex-col ${plan !== "free" ? "border-terracotta bg-white" : "border-border bg-white"}`}>
            ...
            {billingInterval === "yearly" && plan === "free" ? (
              <p className="text-xs text-ink-faint mb-4 h-5">Save $121.80/year </p>
            ) : (
            ...
            <ul className="space-y-2 mb-5 flex-1">
              ...
              <li className="text-xs text-ink-muted"><span className="text-sage font-bold mr-2">&#10003;</span>Bulk generation (CSV)</li>
              <li className="text-xs text-ink-muted"><span className="text-sage font-bold mr-2">&#10003;</span>Brand voice training</li>
              <li className="text-xs text-ink-muted"><span className="text-sage font-bold mr-2">&#10003;</span>A/B title variants</li>
        ...
        <div className="bg-white border border-border rounded-2xl p-6">
          ...
          <div className="flex justify-between items-center py-3 border-b border-cream-dark">
            ...
            <span className="text-sm font-bold capitalize">{plan === "free" ? "Starter (Free)" : "Growth ($29/mo)"}</span>
          </div>
